...
public class RequestBuilder {
    ...
    private static RequestBuilder getInfographicBuilder(final String consumer_key,
            final String consumer_secret, final String id, final ResponseType type) {
     ...
     */
    public static RequestBuilder getInfographicBuilder(final String consumer_key,
            final String consumer_secret, final String id) {
     ...
     */
    public static RequestBuilder getInfographicPngBuilder(final String consumer_key,
            final String consumer_secret, final String id) {
     ...
     */
    public static RequestBuilder getInfographicPdfBuilder(final String consumer_key,
            final String consumer_secret, final String id) {
     ...
     */
    public static RequestBuilder getAllInfographicsBuilder(final String consumer_key,
            final String consumer_secret) {
        String baseUrl = Constants.URL_BASE + "/infographics";
        String requestMethod = "GET";
        List<Parameter> parameters = new ArrayList<Parameter>();
        return new RequestBuilder(consumer_key, consumer_secret, baseUrl, requestMethod, parameters,
                ResponseType.JSON);
    }
     ...
     */
    public static RequestBuilder getUserInfographicsBuilder(final String consumer_key,
            final String consumer_secret, String userID) {
     ...
     */
    public static RequestBuilder postInfographicBuilder(final String consumer_key,
            final String consumer_secret, final String content, final int theme_id,
            final Map<String, String> optParams) {
        String baseUrl = Constants.URL_BASE + "/infographics";
     ...
     */
    public static RequestBuilder putInfographicBuilder(final String consumer_key,
            final String consumer_secret, final String id, final Map<String, String> parameterMap) {
        String baseUrl = String.format("%s/infographics/%s", Constants.URL_BASE, id);
     ...
     * Create a builder for the "PUT Infographic" call.
     */
    public static RequestBuilder deleteInfographicBuilder(final String consumer_key,
            final String consumer_secret, final String id) {
        String baseUrl = String.format("%s/infographics/%s", Constants.URL_BASE, id);
    ...
    /**
     * Constructor of the builder. To be called by one of the static class
     * methods.
     */
    private RequestBuilder(final String consumer_key, final String consumer_secret, final String baseUrl,
    ...
    public Response sendRequest() throws MalformedURLException, IOException {
        ...
        case PDF:
            return new PdfResponse(connection);
        case EMPTY:
